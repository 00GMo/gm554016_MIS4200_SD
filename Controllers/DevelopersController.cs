...
namespace gm554016.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "developerID,developerName,hqLocation,description")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "developerID,developerName,hqLocation,description")] Developer developer)
        {
            if (ModelState.IsValid)
            {
