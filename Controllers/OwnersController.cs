...
namespace gm554016.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ownerID,firstName,lastName,email,phone")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ownerID,firstName,lastName,email,phone")] Owner owner)
        {
            if (ModelState.IsValid)
            {
